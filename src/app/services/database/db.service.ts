...
export class DbService {
  ...
  getUsuarios(filtro: any): any {
    ...
    return this.http.get(this.dbURL + 'getAll/filtro?' + query, {
  ...
  addUsuario(usuario: User, estaciones: any): any {
    ...
    return this.http.post(this.dbURL + 'users/signup', usuario, {
      headers: this.getHeader(),
    });
  }
  ...
  updateUsuario(
    usuario: any,
    addedEstaciones: any,
    deletedEstaciones: any
  ): any {
    return this.http.post(
      this.dbURL + 'users/updateUser',
      { usuario, addedEstaciones, deletedEstaciones },
      { headers: this.getHeader() }
    );
  ...
  getObservadores(estacion: { codigo: string }): any {
    return this.http.post(this.dbURL + 'observers/getObsEstacion', estacion, {
      headers: this.getHeader(),
    });
  }
  ...
  getTipoRegistros(estacion: any): any {
    return this.http.post(
      this.dbURL + 'estacion/getTipoRegistros',
      { id: estacion.id },
      { headers: this.getHeader() }
    );
  }
  ...
  getEstaciones(filtro: any): any {
    ...
    return this.http.get(this.dbURL + 'estacion/getAll/filtro?' + query, {
      headers: this.getHeader(),
    });
  }
  ...
  getEstacionesParaUsuario(filtro: any) {
    ...
    return this.http.get(
      this.dbURL + 'estacion/getAll/filtroSinDivision?' + query,
      { headers: this.getHeader() }
    );
  }
  ...
  addEstacion(estacion: any): any {
    return this.http.post(this.dbURL + 'estacion/new', estacion, {
      headers: this.getHeader(),
    });
   ...
   */
  getPaises(): any {
    return this.http.get(this.dbURL + 'pais/get', {
      headers: this.getHeader(),
    });
  }
  ...
  getFiltroPaises(filtro: any): any {
    ...
    return this.http.get(this.dbURL + 'pais/getAll/filtro?' + query, {
      headers: this.getHeader(),
    });
  }
  ...
  addPais(pais: any): any {
    return this.http.post(this.dbURL + 'pais/new', pais, {
      headers: this.getHeader(),
    });
  }
  ...
  updatePais(pais: any): any {
    return this.http.post(this.dbURL + 'pais/update', pais, {
      headers: this.getHeader(),
    });
  }
   ...
   */
  getDivisiones(): any {
    return this.http.get(this.dbURL + 'division/getAll', {
      headers: this.getHeader(),
    });
  }
  ...
  getFiltroDivisiones(filtro: any): any {
    ...
    return this.http.get(this.dbURL + 'division/getAll/filtro?' + query, {
      headers: this.getHeader(),
    });
  }
   ...
   * @returns respuesta del servidor
   */
  deleteDivision(division: Division): any {
    return this.http.post(this.dbURL + 'division/delete', division, {
      headers: this.getHeader(),
    });
  }
  ...
  addDivision(division: any): any {
    return this.http.post(this.dbURL + 'division/new', division, {
      headers: this.getHeader(),
    });
  }
  ...
  updateDivision(division: any): any {
    return this.http.post(this.dbURL + 'division/update', division, {
      headers: this.getHeader(),
    });
  }
  ...
  getDivisionesSuperiores(idPais: number, nivel: number) {
    return this.http.post(
      this.dbURL + 'division/getDivisionesSuperiores',
      { idPais: idPais, nivel: nivel },
      { headers: this.getHeader() }
    );
  }
  ...
  updateUserPassword(usuario: any): any {
    return this.http.post(this.dbURL + 'users/updatePass', usuario, {
      headers: this.getHeader(),
    });
  }
  ...
  getDivisionesPaises(pais: any): any {
    return this.http.post(
      this.dbURL + 'division/getDivisionesPaisNivelOne',
      { idPais: pais },
      { headers: this.getHeader() }
    );
  }
  ...
  getDivDivisiones(division: any, nivel: any): any {
    return this.http.post(
      this.dbURL + 'division/getDivisionesInferiores',
      { id: division, nivel: nivel },
      { headers: this.getHeader() }
    );
  }

  getFotoEstacion(estacion: any) {
    return this.http.post(this.dbURL + 'estacion/getPicture', estacion, {
      headers: this.getHeader(),
    });
  }
  ...
  activateUser(usuario: any) {
    return this.http.post(this.dbURL + 'users/activateUser', usuario, {
      headers: this.getHeader(),
    });
  }
  activateEstacion(estacion: any) {
    return this.http.post(this.dbURL + 'estacion/activateEstacion', estacion, {
      headers: this.getHeader(),
    });
  }
  activateDivision(division: any) {
    return this.http.post(this.dbURL + 'division/activateDivision', division, {
      headers: this.getHeader(),
    });
  }
  activatePais(pais: any) {
    return this.http.post(this.dbURL + 'pais/activatePais', pais, {
      headers: this.getHeader(),
    });
  }
